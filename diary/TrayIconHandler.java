...
public final class TrayIconHandler {
	...
	public static void registerTrayIcon(Image image, String toolTip,
		...
		if (SystemTray.isSupported()) {
			...
			try {
				...
				System.out.println("I got catch an error during add system tray !");
			}
		} else {
	...
	public static void addItem(String label, String name, int style, int size, ActionListener action) {
		MenuItem menuItem = new MenuItem(label);
		menuItem.setFont(new Font(name, style, size));
